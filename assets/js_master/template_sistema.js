$(document).ready(function () {
    $('#foneInput').mask('(00) 00000-0000');
    $('#cpf').mask('000.000.000-00');
    $('#cpf_usuario_rec').mask('000.000.000-00');
...
function validarCampoCPF_Login() {
    ...
    var Data = document.getElementById("cpf").value;
    var DataSenha = document.getElementById("senha").value;
    var ComponenteLabel = document.getElementById("msn-cpf");
    var ComponenteLayout = document.getElementById("cpf");
