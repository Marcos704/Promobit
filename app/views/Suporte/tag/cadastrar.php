    ...
    <div class="card-body">
      <div class="row">
        <div class="col-12 text-center">
          <h1 class="title">Cadastro de Tag</h1>
              ...
              <div class="form-row">
                <div class="col-lg-12">
                  <div class="form-layout mb-3">
                    ...
                    <input type="text" class="form-control form-control-user custom-input custom-input-width" id="tag" name="tag" placeholder="Tag..." required>
                  </div>
                </div>
...
<script src="<?php echo URL_BASE ?>assets/js_master/cadastrarTag.js"></script>